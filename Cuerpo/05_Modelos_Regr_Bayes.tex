...
Sin embargo, hay ocasiones en las que uno podría esperar que la relación sea diferente a través de diversas subpoblaciones. Esto es, uno pensaría que diferentes subpoblaciones o grupos podrían tener diferentes valores de los coeficientes. Una primera alternativa a esta situación es ajustar regresiones separadas para cada grupo. 
