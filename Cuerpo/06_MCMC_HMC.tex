...
Una distribución posterior puede ser vista como una superficie de cimas y valles. Por ejemplo, la distribución normal es usualmente identificada por su típica forma de campana. Imaginemos que queremos tener una muestra aleatoria de esta distribución. Esperaríamos tener más muestra en la región central--- al rededor de la moda--- que en las colas de la distribución, como puede verse en la \textbf{Figura \ref{fig:Muestra_Normal_Original}}. Si volteamos la función de densidad--- tomando el menos logaritmo, por ejemplo--- esta se convierte en una especie de tazón. Las regiones cercanas a la moda ahora son zonas bajas y las de baja densidad son zonas altas. La muestra se concentra en el fondo del tazón y no en los bordes, como puede verse en la \textbf{Figura \ref{fig:Muestra_Normal_Volteada}}.\\

\begin{figure}[h]
	\centering	
	\begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{Figs/Bayes/Muestra_Normal}
        \caption{La densidad original puede verse como una superficie con una cumbre, al rededor de la cual se concentra la mayoría de las observaciones provenientes de una muestra aleatoria. Por consiguiente, hay menos muestra en las colas de la distribución.}
        \label{fig:Muestra_Normal_Original}
    \end{subfigure}
    ~ 
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{Figs/Bayes/Muestra_Normal_Volteada}
        \caption{Si volteamos la densidad aplicando el menos logaritmo, podemos considerarla una ``función de energía'' cuya gráfica parece un tazón. La muestra se concentra en el fondo del tazón, en lugar de en los bordes del mismo.}
        \label{fig:Muestra_Normal_Volteada}
    \end{subfigure}
	\caption{Una muestra aleatoria proveniente de la distribución normal tiende a concentrarse al rededor de la moda. Fuente: elaboración propia con base en la explicación de {\color{Red} Bed Lambert}.}
	\label{fig:Muestra_Normal}	
\end{figure}

 La idea de voltear la densidad parece rara al inicio, ¿cuál es el objetivo? Podemos tener una analogía con el mundo de la física. El menos logaritmo de la densidad puede considerarse una función de energía potencial para una partícula ficticia. Si se le aplica un \textit{momentum} a una partícula en el tazón, esta rodaría por el tazón siguiendo las leyes de la física y tendería a llegar al fondo del mismo, a los estados de baja energía potencial. 
