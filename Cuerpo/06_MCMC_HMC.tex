...
\end{figure}
 ...
 Imaginemos una partícula ficticia en algún punto de la superficie del tazón. Si le aplicáramos una cantidad de movimiento o \textit{momentum}, esta rodaría por el tazón hacia el fondo del mismo, siguiendo las leyes de la física. Si asumimos que no existe fricción, la partícula continuaría subiendo y bajando, intercambiando energía cinética por energía potencial y viceversa. Bajo esta dinámica, la mayor parte del tiempo la partícula estaría más cerca del fondo del tazón que de los bordes.\\ 
 
 Lo maravilloso de esta idea es que puede ser utilizada para obtener realizaciones provenientes de una distribución objetivo. Es decir, podemos simular este sistema físico ficticio para obtener una muestra aleatoria que no solo cumpla la intuición de tener más observaciones cerca de las modas que en las colas, sino que lo haga en la proporción correcta que marca la ley de probabilidad objetivo.\\ 
 
 De manera informal, lo único que debemos hacer es imaginar una partícula y ``empujarla'' en alguna dirección. Luego seguimos por un tiempo la trayectoria que las leyes de la física determinarían sobre la superficie de nuestra densidad volteada y la ``detenemos''. En este punto registramos su posición en el eje horizontal como una realización de nuestra variable aleatoria. Si volvemos a ponerla en movimiento en una nueva dirección y la seguimos por otro periodo de tiempo llegaríamos a una nueva posición que sería nuestra siguiente observación. Repitiendo este procedimiento obtendríamos una secuencia de observaciones que consituirían nuestra muestra aleatoria. Este método de muestreo se conoce como \textit{Hamiltonian Monte Carlo} o HMC.\\
