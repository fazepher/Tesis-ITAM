...
De manera conceptual, entonces, el algoritmo de \textit{Hamiltonian Monte Carlo} o HMC es un método de MCMC para simular de una distribución $f(\theta)$ de acuerdo con los siguientes pasos: 
\begin{enumerate}
