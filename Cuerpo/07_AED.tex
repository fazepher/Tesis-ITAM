...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.625\textwidth]{Figs/AED/Distr_Votos_Br_P12_FN}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.725\textwidth]{Figs/AED/Pct_Br_Reg_P12_FN}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.75\textwidth]{Figs/AED/Pct_Br_Dpto_P12_FN}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.8\textwidth]{Figs/AED/Mapa_Votos_Br_P12_FN}
...
Las distintas distribuciones de estas variables censales se pueden observar en el \textbf{Anexo B}, para poder ser apreciadas de mejor manera. Comenzando con la distribución del porcentaje de Mujeres en las comunas en 2012 vemos que, como es de esperarse, la mayoría de los departamentos tienen distribuciones muy concentradas al rededor del 50\% de la población. Las únicas distribuciones que llaman la atención en la \textbf{Figura \ref{fig:Distr_por_Dpto_Muj_2012}} son las de los departamentos de Île de France, con porcentajes un poco mayores que el resto de la metrópoli.\\ 
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.75\textwidth]{Figs/AED/Distr_Votos_Br_P12_FN_MUESTRA}
	\caption{Distribuciones del \% bruto de votos para las comunas muestreadas y no muestreadas. Fuente: elaboración propia con base en los datos electorales oficiales del Ministerio del Interior francés}
	\label{fig:Compara_Distr_Muestra}		
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width = 0.8\textwidth]{Figs/AED/Mapa_Votos_Br_P12_FN_MUESTRA}
	\caption{Mapa del \% bruto de votos para las comunas muestreadas. Fuente: elaboración propia con base en los datos electorales oficiales del Ministerio del Interior francés y la cartografía de OpenStreetMap.}
...
\begin{figure}[h]
	\centering
	\includegraphics[width = 0.7\textwidth]{Figs/AED/Dorling_Errores_P12_FN_MUESTRA}
